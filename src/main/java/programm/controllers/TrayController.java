...
public class TrayController {
    ...
    private static void setTrayIcon(PopupMenu popup, Stage inputMainStage) {
        ...
        try {
            Image iconImage = ImageIO.read(TrayController.class.getResourceAsStream("/images/icon.png"));
            trayIcon = new TrayIcon(iconImage, "ТеМон", popup);    // надпись при наведении мыши
    ...
    static void drawTemperatureInTray(int temperature, int minTemperatureLimit, int maxTemperatureLimit) {
        try {
            ...
            graphics2D.setFont(new Font("default", Font.BOLD, 15));
